...
Player data is stored per user under:
  %APPDATA%\PokemonEmeraldRecomp\
...
are build- and platform-validated; do not expect Linux native states to load in
this Windows build.

Third-party runtime licenses are included in the licenses directory.
