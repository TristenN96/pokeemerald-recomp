...
const u8 gItemEffect_EvolutionItem[6] = {
    [4] = ITEM4_EVO_STONE,
};
...
const u8 *const gItemEffectTable[] =
{
    ...
    [ITEM_KINGS_ROCK - ITEM_POTION]    = gItemEffect_EvolutionItem,
    [ITEM_DEEP_SEA_TOOTH - ITEM_POTION] = gItemEffect_EvolutionItem,
    [ITEM_DEEP_SEA_SCALE - ITEM_POTION] = gItemEffect_EvolutionItem,
    [ITEM_METAL_COAT - ITEM_POTION]    = gItemEffect_EvolutionItem,
    [ITEM_DRAGON_SCALE - ITEM_POTION]  = gItemEffect_EvolutionItem,
    [ITEM_UP_GRADE - ITEM_POTION]      = gItemEffect_EvolutionItem,
