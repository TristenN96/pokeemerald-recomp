...
static void PrintPocketNames(const u8 *pocketName1, const u8 *pocketName2)
{
    ...
    CpuCopy32(HostResolveGbaAddr(GetWindowAttribute(windowId, WINDOW_TILE_DATA)), gBagMenu->pocketNameBuffer, sizeof(gBagMenu->pocketNameBuffer));
...
static void CopyPocketNameToWindow(u32 a)
{
    ...
    windowTileData = HostResolveGbaAddr(GetWindowAttribute(2, WINDOW_TILE_DATA));
